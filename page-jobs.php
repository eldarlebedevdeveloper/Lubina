							...
							<div>
								...
								<ul>
									<li>
										...
										<p class="smal-text desc-ver up-string ">
											<?php echo esc_html($personData['person_email']); ?></p>
										<p class="smal-text mob-ver up-string-mob-smille">
											<?php echo esc_html($personData['person_email']); ?></p>
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>/img/phoneBlack.svg" alt="">
										<p class="smal-text"><span class="desc-ver up-string"><?php echo esc_html($personData['person_phone']); ?></span>
										</p>
										<p class="smal-text mob-ver"><span class=" up-string-mob-smille"><?php echo esc_html($personData['person_phone']); ?></span>
										</p>
									</li>
								</ul>
							</div>
