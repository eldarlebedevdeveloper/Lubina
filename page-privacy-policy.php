<?php get_header(); ?>
<section id="privacy_policy" class="imprinit">
	<div class="imprinit_body imprinit_header-container ">
		...
		<p class="w-900">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</p>
		...
		<p class="w-900">Wie erfassen wir Ihre Daten?</p>
		<p>Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z.B. um Daten
			handeln, die Sie in ein Kontaktformular eingeben. Andere Daten werden automatisch beim Besuch der Website
			durch unsere IT-Systeme erfasst. Das sind vor allem technische Daten (z.B. Internet Browser, Betriebssystem
			oder Uhrzeit des Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie unsere Website
			betreten.</p>

		<p class="w-900">Wofür nutzen wir Ihre Daten?</p>
		...
		<p class="w-900">Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
		...
		<p>Beim Besuch unserer Website kann Ihr Surfverhalten statistisch ausgewertet werden. Das geschieht vor allem
			mit Cookies und mit sogenannten Analyseprogrammen. Die Analyse Ihres Surfverhaltens erfolgt in der Regel
			...
			finden Sie in der folgenden Datenschutzerklärung. Sie können dieser Analyse widersprechen. Über die
			Widerspruchsmöglichkeiten werden wir Sie in dieser Datenschutzerklärung informieren.</p>

		<h2>2. Allg. Hinweise und Pflichtinformationen</h2>
		<h3>Datenschutz</h3>
		...
		<p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:
			Lubina engineering GmbH, Hauptstrasse 32, 9030 Abtwil, Schweiz</p>
		...
		<p>Viele Datenverarbeitung Vorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine
		...
		<p>Die Internetseiten verwenden teilweise so genannte Cookies. Cookies richten auf Ihrem Rechner keinen Schaden
			...
			löschen. Diese Cookies ermöglichen es uns, Ihren Browser beim nächsten Besuch wiederzuerkennen. Sie können
			...
			Kommunikation Vorgangs oder zur Bereitstellung bestimmter, von Ihnen gewünschter Funktionen (z.B.
		...
		<p>Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular
			...
			Verarbeitung der in das Kontaktformular eingegebenen Daten erfolgt somit ausschließlich auf Grundlage Ihrer
			...
			Datenverarbeitung Vorgänge bleibt vom Widerruf unberührt. Die von Ihnen im Kontaktformular eingegebenen
		...
		<p>Diese Website nutzt Funktionen des Webanalyse Dienstes Google Analytics. Anbieter ist die Google Inc., 1600
			...
			werden in der Regel an einen Server von Google in den USA übertragen und dort gespeichert. Die Speicherung
			von Google-Analytics-Cookies erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat
		...
		<p>Wir haben auf dieser Website die Funktion IP-Anonymisierung aktiviert. Dadurch wird Ihre IP-Adresse von
			...
			um Reports über die Website Aktivitäten zusammenzustellen und um weitere mit der Websitenutzung und der
		...
		<p>Sie können die Erfassung Ihrer Daten durch Google Analytics verhindern, indem Sie auf folgenden Link klicken.
			...
			verhindert: Google Analytics deaktivieren. Mehr Informationen zum Umgang mit Nutzerdaten bei Google
			Analytics finden Sie in der Datenschutzerklärung von Google:</p>
		<p>https://support.google.com/analytics/answer/6004245?hl=de.</p>

		<h3>Auftragsdatenverarbeitung</h3>
		<p>Wir haben mit Google einen Vertrag zur Auftragsdatenverarbeitung abgeschlossen und setzen die strengen
			Vorgaben der deutschen Datenschutzbehörden bei der Nutzung von Google Analytics vollständig um.</p>
